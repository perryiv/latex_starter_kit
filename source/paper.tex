...
\documentclass[letterpaper, 10 pt, conference]{latex/classes/ieeeconf}

% Needed if you want to use the \thanks command.
% It appears to be like a footnote.
